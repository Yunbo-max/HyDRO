...
if __name__ == '__main__':
    ...
    elif args.method == 'clusteringagg' and args.agg:
    ...
    elif args.method == 'kcenteragg' and args.aggpreprocess:
        agent = KCenterAgg(setting=args.setting, data=graph, args=args)
    elif args.method == 'herding' and not args.aggpreprocess:
        agent = Herding(setting=args.setting, data=graph, args=args)
    elif args.method == 'herdingagg' and args.aggpreprocess:
        agent = HerdingAgg(setting=args.setting, data=graph, args=args)
    elif args.method == 'random':
        agent = Random(setting=args.setting, data=graph, args=args)
    elif args.method == 'cent_p':
    ...
    elif args.method == 'algebraic_jaccard':
        agent = AJ(setting=args.setting, data=graph, args=args)
    elif args.method == 'affinity_GS':
        agent = AffinityGs(setting=args.setting, data=graph, args=args)
    elif args.method == 'kron' and not args.aggpreprocess:
        agent = Kron(setting=args.setting, data=graph, args=args)
    elif args.method == 'heavy_edge' and args.aggpreprocess:
